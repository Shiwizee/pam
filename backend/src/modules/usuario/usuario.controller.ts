import { Controller, Param, Post, Body, Get, Patch, Delete, Query, HttpCode } from '@nestjs/common';
import { UsuarioService } from './usuario.service';
import type { IUsuarioLoginInput, IUsuarioOutput } from './interfaces/usuario.interface';
